...
export class addUnsubscribeEntity1697636165255 implements MigrationInterface {
    name = 'addUnsubscribeEntity1697636165255'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "unsubscribe" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type" character varying NOT NULL, "subscriptionId" integer, "newsletterId" character varying, "savedSearchId" integer, "userId" integer, CONSTRAINT "PK_994fd32a0285bbf2fd462a8601d" PRIMARY KEY ("id"))`);
