...
export class linkSavedSearchToSavedSearchNotification1696880123239 implements MigrationInterface {
    name = 'linkSavedSearchToSavedSearchNotification1696880123239'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "saved_search_notification" DROP COLUMN "savedSearchName"`);
        await queryRunner.query(`ALTER TABLE "saved_search_notification" DROP COLUMN "emailAddress"`);
        await queryRunner.query(`ALTER TABLE "saved_search_notification" ADD "userId" integer`);
        ...
        await queryRunner.query(`ALTER TABLE "saved_search_notification" ADD CONSTRAINT "FK_b0b6344d97495e7e0353e9e21ec" FOREIGN KEY ("savedSearchId") REFERENCES "saved_search"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "saved_search_notification" DROP COLUMN "userId"`);
        await queryRunner.query(`ALTER TABLE "saved_search_notification" ADD "emailAddress" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "saved_search_notification" ADD "savedSearchName" character varying NOT NULL`);
    }
